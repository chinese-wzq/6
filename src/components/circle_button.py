...
class CircleButton(QWidget):
    ...
    def _load_config_and_setup_variables(self):
        ...
        self._border_radius = config["主题"]["圆角半径"]
        self._border_width = config["主题"]["数字6标识"]["描边宽度"]
        ...
        self._background_color = list(map(int, config["主题"]["数字6标识"]["背景颜色"].split(',')))
        self._border_color = list(map(int, config["主题"]["数字6标识"]["描边颜色"].split(',')))
        ...
        self._paint_bottom_parameters = (self._half_border_width,
                                         ...
                                         self._border_radius_times_2,
                                         self._border_radius_times_2)
        self._QFont = QFont(config["主题"]["字体"], self.font_pointSize, self.font_weight)
        self._QFont_color = list(map(int, config["主题"]["数字6标识"]["字体颜色"].split(',')))
